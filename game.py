    ...
    while timeRace < TIME_RACE:
        ...
        for event in pygame.event.get():
            ...
            if(event.type == pygame.KEYDOWN):
                ...
                if event.key == pygame.K_s :
                    # Save best NN
                    # best_car = max(cars, key=attrgetter('totalDistance'))
                    with open('car_nn{}.pkl'.format(VIEW_RANGE), 'wb') as file :
                        pickle.dump(best_car.nn, file)
                    print("NN saved")
        ...
        for car in cars :
            ...
            for p in range(len(interior)-1):
                ...
                if dist3 is None :
                    dist3 = cd.calculateIntersectPoint([car.x, car.y], [car.x+dx3*VIEW_RANGE,car.y+dy3*VIEW_RANGE],
                                        [interior[p][0], interior[p][1]], [interior[p+1][0], interior[p+1][1]])
                if dist4 is None :
                    dist4 = cd.calculateIntersectPoint([car.x, car.y], [car.x-dx1*VIEW_RANGE,car.y-dy1*VIEW_RANGE],
                                        [interior[p][0], interior[p][1]], [interior[p+1][0], interior[p+1][1]])
            ...
            if dist4 is None :
                ...
                dist4 = math.sqrt( (car.x-dist4[0])**2 + (car.y-dist4[1])**2 )
            ...
            for p in range(len(checkpoints)-1):
                dist = cd.calculateIntersectPoint([car.x, car.y], [car.x+dx1*VIEW_RANGE,car.y+dy1*VIEW_RANGE],
            ...
            if dist1 < VIEW_RANGE :
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (255,0,0),(car.x,car.y),(car.x+dx1*VIEW_RANGE,car.y+dy1*VIEW_RANGE))
            else:
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (0,255,0),(car.x,car.y),(car.x+dx1*VIEW_RANGE,car.y+dy1*VIEW_RANGE))
            if dist2 < VIEW_RANGE :
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (255,0,0),(car.x,car.y),(car.x+dx2*VIEW_RANGE,car.y+dy2*VIEW_RANGE))
            else:
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (0,255,0),(car.x,car.y),(car.x+dx2*VIEW_RANGE,car.y+dy2*VIEW_RANGE))
            if dist3 < VIEW_RANGE :
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (255,0,0),(car.x,car.y),(car.x+dx3*VIEW_RANGE,car.y+dy3*VIEW_RANGE))
            else:
                VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (0,255,0),(car.x,car.y),(car.x+dx3*VIEW_RANGE,car.y+dy3*VIEW_RANGE))
            # if dist4 < VIEW_RANGE :
            #     VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (255,0,0),(car.x,car.y),(car.x-dx1*VIEW_RANGE,car.y-dx1*VIEW_RANGE))
            # else:
            #     VIEW_MODE and car.visible and pygame.draw.line(lineSurface, (0,255,0),(car.x,car.y),(car.x-dx1*VIEW_RANGE,car.y-dx1*VIEW_RANGE))
